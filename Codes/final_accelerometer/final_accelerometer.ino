...
void loop() {
  ...
  int x = map(xval, 263, 394, -100, 100);               //maps the extreme ends analog values from -100 to 100 for our understanding
  ...
  int y = map(yval, 266, 399, -100, 100);
  ...
  */
  ...
  int z = map(zval, 269, 400, -100, 100);
